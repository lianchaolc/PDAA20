...
//				//===================================
	...
	private void initView() {
		...
		this.adapterLockType = ArrayAdapter.createFromResource(this, R.array.arr_lockType,
		...
		this.copy.setOnClickListener(new OnClickListener() {
...
//					Toast.makeText(getApplicationContext(), "读数据失败", Toast.LENGTH_SHORT).show();
		...
		case R.id.button_write:
			for (int i = 0; i < 5; i++) {
				...
				// boolean writeFlag = manager.writeTo6C(accessPassword, membank, addr,

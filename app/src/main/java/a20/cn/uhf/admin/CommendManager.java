...
public interface CommendManager {
	...
	/**
	 * ����� int memBank����� int startAddr�������ʼ��ַ������Ϊ��λ�� int
	 * lengthҪ��ȡ����ݳ���(����Ϊ��λ) byte[] accessPassword �������� ���ص�byte[] Ϊ EPC
	 * + ��ȡ�����
	 */
	public byte[] readFrom6C(int memBank, int startAddr, int length, byte[] accessPassword);

	/**
	 * д��� byte[] password �������� int memBank ����� int startAddr
	 * ��ʼ��ַ����WORDΪ��λ�� int wordCnt д����ݵĳ��ȣ���WORDΪ��λ 1word = 2bytes��
	 * byte[] data д����� ���� boolean��trueд�������ȷ��falseд�����ʧ��
	 */

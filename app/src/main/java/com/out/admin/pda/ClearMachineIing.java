	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				/**
				 * Modify begin by zhangxuewei at 05-dec-2016 重新加钞时，清空listview显示内容
				 */
				list_result.clear();
				/** Modify end */
			}
	...
	public void show() {
		if (ClearMachineIngBiz.msg != null) {
			if (ClearMachineIngBiz.msg.indexOf("ATM") > 0) {
				...
				String body = ClearMachineIngBiz.msg.substring(ClearMachineIngBiz.msg.indexOf("ATM"),
						ClearMachineIngBiz.msg.length());

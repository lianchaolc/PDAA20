...
public class CleanAtmAddMoneyService {
     ...
     * @throws Exception
     */
    public List<ClearMoney> cleanAtmAddMoney(String cashboxNums, String corpId, String userId1, String userId2)
            throws Exception {

        String methodName = "updateAndCleanAtmAddMoney";
        Log.i("CleanAtmAddMoneyService", cashboxNums);
        Log.i("2", corpId);
        Log.i("3", userId1);
        Log.i("4", userId2);
        WebParameter[] param = {new WebParameter<String>("arg0", cashboxNums),
                new WebParameter<String>("arg1", corpId), new WebParameter<String>("arg2", userId1),

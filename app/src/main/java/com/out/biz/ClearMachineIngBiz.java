...
public class ClearMachineIngBiz {
	...
	/**
	 * 
	 * @param cashboxNums 钞箱编号列表
	 * @param corpId      机构ID
	 * @param userId1     用户ID
	 * @param userId2     用户ID
	 */
	public void cleanAtmAddMoney(String cashboxNums, String corpId, String userId1, String userId2) {
	...
	class Run implements Runnable {
		...
		public Run(String cashboxNums, String corpId, String userId1, String userId2) {
		...
		public void run() {
			try {
				list = getCleanAtmAddMoneyService().cleanAtmAddMoney(cashboxNums, corpId, userId1, userId2);

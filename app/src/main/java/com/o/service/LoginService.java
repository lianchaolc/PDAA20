...
public class LoginService {
	public User Login(String name, String pwd) throws Exception {
		...
		WebParameter[] param = { new WebParameter<String>("arg0", name), new WebParameter<String>("arg1", pwd) };
	 ...
	 * @throws Exception
	 */
	public User checkFingerprint(String corpId, String roleId, byte[] cValue, String userId, String pwd)
			throws Exception {
		User user = null;
		...
		WebParameter[] param = { new WebParameter<String>("arg0", corpId), new WebParameter<String>("arg1", roleId),
				new WebParameter<byte[]>("arg2", cValue), new WebParameter<String>("arg3", userId),

...
public class KuanxiangjiaojieService {
     ...
     * @throws Exception
     */
    public List<String> getBoxHandoverDetail(String corpId, String type) throws Exception {
        S_box box = null;
        String methodName = "getBoxHandoverDetail";
        WebParameter[] param = {new WebParameter<String>("arg0", corpId), new WebParameter<String>("arg1", type)};
        System.out.println("-----------getBoxHandoverDetail传入的参数-机构id:" + corpId + ",state：" + type);
        SoapObject soap = null;
        soap = WebService.getSoapObject2(methodName, param);
        ...
        if (code.equals("00")) {
            ...
            System.out.println("[service------------getBoxHandoverDetail]:" + list.size());
            return list;
        }
        return null;
    }
     ...
     * @throws Exception
     */
    public String saveBoxHandover(String lineNum, String boxes, String corpIdOfBox, String corpId, String roleId,
        ...
        WebParameter[] param = {new WebParameter<String>("arg0", lineNum), new WebParameter<String>("arg1", boxes),
                new WebParameter<String>("arg2", corpIdOfBox), new WebParameter<String>("arg3", corpId),
        ...
        System.out.println("-----------getBoxHandoverDetail传入的参数-机构id:" + "lineNum:" + lineNum + ",boxes：" + boxes
                + ",corpIdOfBox：" + corpIdOfBox + ",corpId：" + corpId + ",roleId：" + roleId + ",cValue：" + cValue
                + ",userIds：" + userIds + ",userId：" + userId + ",pwd：" + pwd);
        SoapObject soap = null;
        soap = WebService.getSoapObject2(methodName, param);
     ...
     * @throws Exception
     */
    public String saveBoxHandoverStorageLate(String lineNum, String boxes, String toboxes, String date,
                                             String corpIdOfBox, String corpId, String roleId, byte[] cValue, String userIds, String userId, String pwd)
            throws Exception {
        String methodName = "saveBoxHandoverStorageLate";
        WebParameter[] param = {new WebParameter<String>("arg0", lineNum), new WebParameter<String>("arg1", boxes),
                new WebParameter<String>("arg2", toboxes), new WebParameter<String>("arg3", date),
                new WebParameter<String>("arg4", corpIdOfBox), new WebParameter<String>("arg5", corpId),
                new WebParameter<String>("arg6", roleId), new WebParameter<byte[]>("arg7", cValue),
                new WebParameter<String>("arg8", userIds), new WebParameter<String>("arg9", userId),
    ...
    /****
     * 2022.1.13 款箱网点人员和押运员关系绑定接口
     * 网点人员1
     * 网点人员2
     * 押运员
     */
    public String receiveLineTask(String netPoint, String netPointUse, String CarDriver) throws Exception {
        Log.i("", "传递参数：");
        Log.i("KuanxiangjiaojieService", "netPoint=" + netPoint);
        Log.i("KuanxiangjiaojieService", "netPointUse=" + netPointUse);
        Log.i("KuanxiangjiaojieService", "CarDriver=" + CarDriver);
        String methodName = "receiveLineTask";
        WebParameter[] param = {
                new WebParameter<String>("arg0", netPoint),
                new WebParameter<String>("arg1", netPointUse),
                new WebParameter<String>("arg2", CarDriver),
        };
        System.out.println("-----------receiveLineTask传入的参数-:" + netPoint + ",netPointUse：" + netPointUse + CarDriver);
        SoapObject soap = null;
        soap = WebService.getSoapObject2(methodName, param);
        System.out.println("-------receiveLineTask:" + soap);
        String code = soap.getProperty("code").toString();
        String msg = soap.getProperty("msg").toString();
        String params = soap.getProperty("params").toString();
        if (code.equals("00")) {
            System.out.println("[service------------receiveLineTask]:");
            return code;
        } else {
            return msg;
        }

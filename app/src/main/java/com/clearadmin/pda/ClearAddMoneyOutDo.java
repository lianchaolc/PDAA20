...
public class ClearAddMoneyOutDo extends Activity {
		...
		AddMoneygetNum.handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				case 1:
					...
					managerClass.getRuning().runding(ClearAddMoneyOutDo.this, "正在获取钞箱信息...");
					// 开启线程，获取钞箱的信息
		...
		getGetAddMoneySum().handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				case 1:
					...
					// 打开二维码扫描
					SoundUtil.mContext = ClearAddMoneyOutDo.this;
					...
					break;
				case 0:
					managerClass.getSureCancel().makeSuerCancel(ClearAddMoneyOutDo.this, "没有这个钞箱的记录",
			...
			public void handleMessage(Message msg) {
				...
				case 1:
					...
					if (moneyCount(toal)) {
						...
						// modify by wangmeng 2017-8-28 当钱数不对时，确认按钮为灰色
		...
		getAddMoneyConfirm().handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				case 1:
					...
					// 加钞成功提示
					managerClass.getSureCancel().makeSuerCancel(ClearAddMoneyOutDo.this, "加钞成功",
							new View.OnClickListener() {
								@Override
								public void onClick(View arg0) {
									managerClass.getSureCancel().remove();
					...
					if (getAddMoneygetNum().map.size() == 0) {
						...
						managerClass.getSureCancel().makeSuerCancel(ClearAddMoneyOutDo.this, "所有钞箱扫描完毕！",
								new View.OnClickListener() {
									@Override
									public void onClick(View arg0) {
										managerClass.getSureCancel().remove();
										new GolbalUtil().gotoActivity(ClearAddMoneyOutDo.this, ClearManager.class, null,
												0);
									}
								}, true);
					} else {
				...
				case 0:
					// 加钞提示
					managerClass.getSureCancel().makeSuerCancel(ClearAddMoneyOutDo.this, "加钞失败",
							new View.OnClickListener() {
								@Override
								public void onClick(View arg0) {
									managerClass.getSureCancel().remove();
	...
	class Ad extends BaseAdapter {
		...
		public View getView(int arg0, View view, ViewGroup arg2) {
			...
			// 删除触摸事件
			holder.del.setOnTouchListener(new OnTouchListener() {
		...
		public boolean onTouch(View view, MotionEvent even) {
			...
			if (MotionEvent.ACTION_UP == even.getAction()) {
				...
				case R.id.addmoney_suer_out:
					btn.setBackgroundResource(R.drawable.buttom_selector_bg);
					// 为钱捆参数赋值
					if ((!bagNum1.equals("")) || (!bagNum2.equals("")) || (!bagNum3.equals("")) || (!bagNum4.equals(""))
							|| (!bagNum5.equals("")) || (!bagNum6.equals(""))) {
						bagNum1 = "";
						bagNum2 = "";
						bagNum3 = "";
						bagNum4 = "";
					...
					getAddMoneyConfirm().addMoneyConfrim(plan, GetAddMoneySumBiz.box.getNum(),
							BankDoublePersonLogin.userid1, BankDoublePersonLogin.userid2,
							GApplication.user.getOrganizationId(), bagNum1, bagNum2, bagNum3, bagNum4, bagNum5,
							bagNum6);
					break;
				}
	...
	protected void onPause() {
		...
		// 当页面放回上一页面上时，清空钱捆编号保存的集合和钱捆编号的集合
		for (int i = 0; i < getGetMoneyNum().list.size(); i++) {
			getGetMoneyNum().list_save.remove(getGetMoneyNum().list.get(i));
			break;
		}
		getGetMoneyNum().list.clear();
	}

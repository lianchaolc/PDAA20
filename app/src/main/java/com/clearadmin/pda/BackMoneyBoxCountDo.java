...
public class BackMoneyBoxCountDo extends Activity {
	...
	RecycleCashboxCheckConfirmBiz getRecycleCashboxCheckConfirm() {
		return recycleCashboxCheckConfirm = recycleCashboxCheckConfirm == null ? new RecycleCashboxCheckConfirmBiz()
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		click = new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				getRecycleCashboxCheckConfirm().getCheckConfirmResult(cashboxNum, orderNum, balance1, balance2,
		...
		getRecycleCashboxCheckConfirm().handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				switch (msg.what) {
				case 0:
					managerClass.getSureCancel().makeSuerCancel(BackMoneyBoxCountDo.this, "清点失败！",
				...
				case 1:
					...
					if (BackCleanBox.map.size() == 0) {
						/**
						 * 所有钞算清点完毕 改为 所有钞箱清点完毕 by zhangxuewei
						 */
						managerClass.getSureCancel().makeSuerCancel(BackMoneyBoxCountDo.this, "所有钞箱清点完毕",
								new View.OnClickListener() {
									@Override
									public void onClick(View arg0) {
										managerClass.getSureCancel().remove();
										new GolbalUtil().gotoActivity(BackMoneyBoxCountDo.this, ClearManager.class,
												null, 0);
				...
				case -4:
					...
					break;
				case -88:
					managerClass.getGolbalView().toastShow(BackMoneyBoxCountDo.this, "该钞箱已审核通过，不能再次清分！！");
				}
			}
		};
		...
		BackCleanBox.handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				case 1:
					...
					// 获取钞箱信息
					getRecycleCashboxCheckInfo().getrecycleCashboxCheckInfo(planNum, cashbox,
							BankDoublePersonLogin.userid1, BankDoublePersonLogin.userid2,
...
//		box.setMoney(array[2]);
		...
		getboxclick = new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				managerClass.getRuning().runding(BackMoneyBoxCountDo.this, "正在获取信息...");
				// 获取钞箱信息
				getRecycleCashboxCheckInfo().getrecycleCashboxCheckInfo(planNum, cashbox, BankDoublePersonLogin.userid1,
		...
		public boolean onTouch(View view, MotionEvent even) {
			...
			if (MotionEvent.ACTION_UP == even.getAction()) {
				...
				case R.id.count_suer:
					...
					/** begin modify by wangmeng 手动输入，有可能没输，进行提示 */
					if ("".equals(balance1)) {
						managerClass.getGolbalView().toastShow(BackMoneyBoxCountDo.this, "请输入钞箱余额!!");
					} else {
						managerClass.getRuning().runding(BackMoneyBoxCountDo.this, "正在清点...");
						getRecycleCashboxCheckConfirm().getCheckConfirmResult(cashboxNum, orderNum, balance1, balance2,
								BankDoublePersonLogin.userid1, BankDoublePersonLogin.userid2);
					}
					/** end modify by wangmeng 手动输入，有可能没输，进行提示 */
					break;

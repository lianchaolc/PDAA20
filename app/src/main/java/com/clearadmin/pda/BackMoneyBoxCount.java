...
public class BackMoneyBoxCount extends Activity implements OnTouchListener {
	...
	RecycleCashboxCheckDetailBiz getRecycleCashboxCheckDetail() {
		return recycleCashboxCheckDetail = recycleCashboxCheckDetail == null ? new RecycleCashboxCheckDetailBiz()
				: recycleCashboxCheckDetail;
	}
	...
	public boolean onTouch(View view, MotionEvent even) {
		...
		if (MotionEvent.ACTION_UP == even.getAction()) {
			...
			case R.id.countdo:
				...
				managerClass.getGolbalutil().gotoActivity(BackMoneyBoxCount.this, BackMoneyBoxCountDo.class, bundle,
						GolbalUtil.ismover);
				break;

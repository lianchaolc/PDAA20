...
public class AddMoneyConfirmBiz {
	...
	public void addMoneyConfrim(String planNum, String cashboxNum, String userId1, String userId2, String corpId,
		...
		if (GolbalUtil.onclicks) {
			...
			Thread t = new Thread(new Run(planNum, cashboxNum, userId1, userId2, corpId, bagNum1, bagNum2, bagNum3,
					bagNum4, bagNum5, bagNum6));
			t.start();
		}
	}
	...
	class Run implements Runnable {
		...
		public Run(String planNum, String cashboxNum, String userId1, String userId2, String corpId, String bagNum1,
				String bagNum2, String bagNum3, String bagNum4, String bagNum5, String bagNum6) {
		...
		public void run() {
			try {
				if (getDddMoneyConfrim().addMoneyConfirm(planNum, cashboxNum, userId1, userId2, corpId, bagNum1,
						bagNum2, bagNum3, bagNum4, bagNum5, bagNum6)) {
					m.what = 1;
				} else {
					m.what = 0;
				}

...
public class AddMoneyConfrimService {
	...
	public boolean addMoneyConfirm(String planNum, String cashboxNum, String userId1, String userId2, String corpId,
		...
		WebParameter[] param = { new WebParameter<String>("arg0", planNum),
				new WebParameter<String>("arg1", cashboxNum), new WebParameter<String>("arg2", userId1),
				new WebParameter<String>("arg3", userId2), new WebParameter<String>("arg4", corpId),
				new WebParameter<String>("arg5", bagNum1), new WebParameter<String>("arg6", bagNum2),
				new WebParameter<String>("arg7", bagNum3), new WebParameter<String>("arg8", bagNum4),
				new WebParameter<String>("arg9", bagNum5), new WebParameter<String>("arg10", bagNum6), };
		Log.i("arg0", planNum);

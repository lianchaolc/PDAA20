...
public class KuanXiangJiaoJieYaYunActivity extends BaseFingerActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        load();
        System.out.println("GApplication.jiaojiestate:" + GApplication.jiaojiestate);
    ...
    public void yanzhengFinger() {
        manager.getRuning().runding(KuanXiangJiaoJieYaYunActivity.this, "验证中...");
        new Thread() {
            @Override
            public void run() {
                super.run();
                ...
                try {
                    ...
                    result_user2 = yz.yanzhengfinger(GApplication.loginJidouId, "9", ShareUtil.ivalBack);
    ...
    public void saveBoxinfo() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                userIds = ShareUtil.zhiwenid_left + "|" + ShareUtil.zhiwenid_right;
                try {
                    if (ShareUtil.zhiwenid_left != null && ShareUtil.zhiwenid_right != null) {
                        ...
                        zsisOk = kj.saveBoxHandover(GApplication.kxc.getXianlubianhao(),
                                Box.substring(0, Box.length() - 1), GApplication.sk.getNetId(), // listView列表对象的网点号
                                GApplication.loginJidouId, GApplication.loginjueseid, ShareUtil.ivalBack,
                ...
                try {
                    if (ShareUtil.zhiwenid_left != null && ShareUtil.zhiwenid_right != null) {
                        ...
                        code = kj.saveBoxHandoverStorageLate(GApplication.kxc.getXianlubianhao(),
                                boxes.substring(0, boxes.length() - 1), toboxes, date, wangDian, yayunjgId, roleId,
                                ShareUtil.ivalBack, userIds, GApplication.userInfo.getNameZhanghao(),
            ...
            public void run() {
                ...
                try {
                    ...
                    if (ShareUtil.zhiwenid_left != null && ShareUtil.zhiwenid_right != null) {
                        ...
                        // 款箱晚收交接
                        wisOk = kj.saveBoxHandoverStorageLate(GApplication.kxc.getXianlubianhao(),
                                kunqian + toBoxes.substring(0, toBoxes.length() - 2), "", "",
                                GApplication.sk.getNetId(), GApplication.loginJidouId, GApplication.loginjueseid,
                                ShareUtil.ivalBack, userIds, GApplication.userInfo.getNameZhanghao(),
                                GApplication.userInfo.getPwd());
                    } else if (ShareUtil.zhiwenid_left != null && ShareUtil.zhiwenid_right == null) {
                        // 第一个人验证成功，第二个人验证失败
            ...
            switch (msg.what) {
                ...
                case 0:
                    ...
                    manager.getSureCancel().makeSuerCancel2(
                            ...
                            KuanXiangJiaoJieYaYunActivity.this, "押运员：" + yayunname, new View.OnClickListener() {
                ...
                case 5:
                    manager.getRuning().remove();
                    manager.getAbnormal().timeout(KuanXiangJiaoJieYaYunActivity.this, "晚收早送申请提交失败,重试?",
                ...
                case 7:
                    manager.getRuning().remove();
                    manager.getAbnormal().timeout(KuanXiangJiaoJieYaYunActivity.this, "提交异常,重试?",
                            new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    saveBoxWanShou();
                ...
                case 9:
                    manager.getRuning().remove();
                    manager.getAbnormal().timeout(KuanXiangJiaoJieYaYunActivity.this, "晚收不早送提交失败,重试?",
                            new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    saveNoZsBoxWanShou();
                ...
                case 11:
                    manager.getRuning().remove();
                    manager.getAbnormal().timeout(KuanXiangJiaoJieYaYunActivity.this, "网络连接失败,重试?",
                            new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    saveNoZsBoxWanShou();

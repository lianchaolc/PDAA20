 ...
 */
public class ZaoSongshenqingActivity extends Activity
		implements OnClickListener, OnDateSetListener, OnCheckedChangeListener {
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				break;
			case 1:// 超时
				manager.getAbnormal().timeout(ZaoSongshenqingActivity.this, "获取日期超时,重试?", new OnClickListener() {
					@Override
				...
				break;
			case 2:// 获取失败
				manager.getAbnormal().timeout(ZaoSongshenqingActivity.this, "获取日期失败,重试?", new OnClickListener() {
				...
				break;
			case 3:// 加载异常
				manager.getAbnormal().timeout(ZaoSongshenqingActivity.this, "加载日期异常,重试?", new OnClickListener() {
	...
	class ZaoSsqing extends BaseAdapter {
		...
		public View getView(final int arg0, View arg1, ViewGroup arg2) {
			...
			if (arg1 == null) {
				...
				arg1 = LayoutInflater.from(ZaoSongshenqingActivity.this).inflate(R.layout.item_zaosongshenqing, null);
	...
	public void onClick(View arg0) {
		...
		case R.id.zaochushenqing_button2:// 跳转晚收款箱交接
			...
			/*
			 * if (GApplication.zssqlist != null) { //GApplication.zslist = clist; for (int
			 * i = 0; i < GApplication.zssqlist.size(); i++) {
			 * System.out.println("GApplication.zssqlist:"+GApplication.zssqlist.get(i).
			 * getEdit());
			 * System.out.println("GApplication.zssqlist:"+GApplication.zssqlist.get(i).
			 * getBoxId()); } }
			 */
			...
			break;
		/*
		 * case R.id.zcsqBack: ZaoSongshenqingActivity.this.finish(); break;
		 */
		case R.id.btnTime:
...
//			d = new Date(mingtian); // 将毫秒再转成时间
			...
			quXBt.setOnClickListener(new OnClickListener() {
				@Override
				public void onClick(View arg0) {
					dialog.dismiss();
				}
	...
	public void onDateSet(DatePicker dialog, int year, int month, int day) {
		/*
		 * //calendar.set(year, month, day); String date = year + "-" + (month + 1) +
		 * "-" + day; zaoDate.setText(date.toString());
		 */
	}

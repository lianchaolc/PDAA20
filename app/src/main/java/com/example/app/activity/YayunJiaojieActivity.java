...
public class YayunJiaojieActivity extends BaseFingerActivity {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result_user = yz.yanzhengfinger(GApplication.user.getOrganizationId(), "9", ShareUtil.ivalBack);
                    if (result_user != null) {
    ...
    public void saveBoxInfo() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    String bianhao = "";
                    String ids = ShareUtil.zhiwenid_left + "|" + ShareUtil.zhiwenid_right;
                    ...
                    if (ShareUtil.zhiwenid_left != null && ShareUtil.zhiwenid_right != null) {
                        ...
                        code = cc.saveBoxSendOutEarly(GApplication.kxc.getXianlubianhao(), bianhao,
                                GApplication.kxc.getPeisongdate(), GApplication.user.getOrganizationId(), "9",
                                ShareUtil.ivalBack, ids, GApplication.userInfo.getNameZhanghao(),
                        ...
                        System.out.println("出库时---第一个人验证成功，第二个人验证失败的方法========");
                        // 第一个人验证成功，第二个人验证失败
                        ChuKuCaoZuoSerivce cc = new ChuKuCaoZuoSerivce();
                        code = cc.saveBoxSendOutEarly(GApplication.kxc.getXianlubianhao(), bianhao,
                        ...
                        code = cc.saveBoxSendOutEarly(GApplication.kxc.getXianlubianhao(), bianhao,
                                GApplication.kxc.getPeisongdate(), GApplication.user.getOrganizationId(), "9",
                                ShareUtil.ivalBack,
                                GApplication.kuguan1.getUserzhanghu() + "|" + ShareUtil.zhiwenid_right,
                                GApplication.userInfo.getNameZhanghao(), GApplication.userInfo.getPwd());
                        ...
                        code = cc.saveBoxSendOutEarly(GApplication.kxc.getXianlubianhao(), bianhao,
                                GApplication.kxc.getPeisongdate(), GApplication.user.getOrganizationId(), "9",
                                ShareUtil.ivalBack,
                                GApplication.kuguan1.getUserzhanghu() + "|" + GApplication.kuguan2.getUserzhanghu(),
                                GApplication.userInfo.getNameZhanghao(), GApplication.userInfo.getPwd());
                    }
            ...
            public void run() {
                ...
                try {
                    if (ShareUtil.zhiwenid_left != null && ShareUtil.zhiwenid_right != null) {
                        ...
                        ChuKuCaoZuoSerivce cc = new ChuKuCaoZuoSerivce();
                        code = cc.saveBoxStorageLate(GApplication.kxc.getXianlubianhao(), bianhao,
                                GApplication.user.getOrganizationId(), "9", ShareUtil.ivalBack, ids,
                                GApplication.userInfo.getNameZhanghao(), GApplication.userInfo.getPwd());
                    } else if (ShareUtil.zhiwenid_left != null && ShareUtil.zhiwenid_right == null) {
                        ...
                        ChuKuCaoZuoSerivce cc = new ChuKuCaoZuoSerivce();
                        code = cc.saveBoxStorageLate(GApplication.kxc.getXianlubianhao(), bianhao,
                                GApplication.user.getOrganizationId(), "9", ShareUtil.ivalBack,
                                ShareUtil.zhiwenid_left + "|" + GApplication.kuguan2.getUserzhanghu(),
                                GApplication.userInfo.getNameZhanghao(), GApplication.userInfo.getPwd());
                    } else if (ShareUtil.zhiwenid_left == null && ShareUtil.zhiwenid_right != null) {
                        // 第一个人验证失败，第二个人验证成功
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 12:
                    manager.getRuning().remove();
                    manager.getAbnormal().timeout(YayunJiaojieActivity.this, "提交超时,重试?", new OnClickListener() {
                ...
                case 2:
                    manager.getRuning().remove();
                    manager.getAbnormal().timeout(YayunJiaojieActivity.this, "提交失败,重试?", new OnClickListener() {
                ...
                case 13:
                    manager.getRuning().remove();
                    manager.getAbnormal().timeout(YayunJiaojieActivity.this, "网络连接失败,重试?", new OnClickListener() {
...
//				}
                    ...
                    manager.getSureCancel().makeSuerCancel2(YayunJiaojieActivity.this, "押运员：" + result_user.getUsername(),
                            new OnClickListener() {
                                @Override
                                public void onClick(View arg0) {
                                    ...
                                    // 交接
                                    if (GApplication.chukubiaoshi == 1) {
                                        manager.getRuning().runding(YayunJiaojieActivity.this, "验证成功，正在提交数据");
                                        saveBoxInfo();
                                    } else if (GApplication.chukubiaoshi == 2) {
                                        manager.getRuning().runding(YayunJiaojieActivity.this, "验证成功，正在提交数据");
                                        WanSaveBoex();
                ...
                case 8:
                    ...
                    if (count >= 3) {
                        ...
                        Skip.skip(YayunJiaojieActivity.this, YayunCheckFingerActivity.class, budnle, 0);
                    }
                    break;
                case 9:
                    manager.getRuning().remove();
                ...
                case 11:
                    ...
                    manager.getRuning().remove();
                    manager.getGoBack().back(YayunJiaojieActivity.this, xiaoxi, new OnClickListener() {
                        @Override
                        public void onClick(View arg0) {

...
public class KuanXiangMingXiActivity extends Activity implements OnClickListener {
	private Button back;
	...
	private class ZaochuAdapter extends BaseAdapter {
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			if (arg1 == null) {
				...
				arg1 = LayoutInflater.from(KuanXiangMingXiActivity.this).inflate(R.layout.s_item_kuangxiangmingxi,
						null);
	...
	public void onClick(View v) {
		/*
		 * switch (v.getId()) { case R.id.mingxi_back:
		 * KuanXiangMingXiActivity.this.finish(); break; default: break; }
		 */

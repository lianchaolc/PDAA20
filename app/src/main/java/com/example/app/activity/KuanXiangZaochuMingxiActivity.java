...
//	private ImageView back;
	private TextView tv_chaoche, tv_wangdian, tv_kuanxiang, tv_date, ym_show;// 页面标题显示文字
	KuanXiangChuRu kx;
	...
	public void ButtonListener() {
		...
		bt_chuku.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Skip.skip(KuanXiangZaochuMingxiActivity.this, KuanXiangChuKuActivity.class, null, 0);
			}
		});
		/*

 ...
 */
public class KuanXiangChuKuActivity extends Activity implements OnClickListener, OnItemClickListener {
				...
				for (int j = 0; j < GApplication.saolist.size(); j++) {
					for (int i = 0; i < GApplication.mingxi_list.size(); i++) {
						if (GApplication.saolist != null
								&& GApplication.saolist.get(j).equals(GApplication.mingxi_list.get(i).getBoxIds())) {
							BoxDetail bd = new BoxDetail();
...
//				}
	...
	protected void onResume() {
		...
		/*
		 * listView.setAdapter(adapter); TestHangGao(listView);
		 */
	}
	...
	class showListAdapter extends BaseAdapter {
		...
		public View getView(final int arg0, View view, ViewGroup arg2) {
			...
			if (v == null) {
				v = GolbalView.getLF(KuanXiangChuKuActivity.this).inflate(R.layout.boxinformation_item, null);
			...
			holder.Num.setOnTouchListener(new OnTouchListener() {
				...
				public boolean onTouch(View view, MotionEvent even) {
					...
					if (MotionEvent.ACTION_UP == even.getAction()) {
						...
						manager.getSureCancel().makeSuerCancel(KuanXiangChuKuActivity.this,
								"确认删除" + ((BoxDetail) getItem(arg0)).getNum() + "?", new OnClickListener() {
									@Override
	...
	@Override
	public void onItemClick(AdapterView<?> arg0, View arg1, final int checkId, long arg3) {
		/*
		 * ischeckid = checkId;
		 * manager.getAbnormal().timeout(KuanXiangChuKuActivity.this, "是否删除", OnClick);
		 */
	}
	...
	public void onClick(View arg0) {
		/*
		 * if (arg0 == back) { KuanXiangChuKuActivity.this.finish(); }
		 */
		if (arg0 == quxiao) {
		...
		if (arg0 == chuku) {
			...
			Skip.skip(KuanXiangChuKuActivity.this, YayunJiaojieActivity.class, null, 0);
		}
	}

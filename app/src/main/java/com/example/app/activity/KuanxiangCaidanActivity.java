	...
	private class ShijianChuli implements OnClickListener {
		...
		public void onClick(View arg0) {
			...
			case R.id.money_box_admins:
				// 出入库管理
				manager.getRuning().runding(KuanxiangCaidanActivity.this, "指纹功能开启中...");
				Skip.skip(KuanxiangCaidanActivity.this, KuguanDengluActivity.class, null, 0);
				break;
			case R.id.kuanxiangjiaojie:
				// 款箱交接
				Skip.skip(KuanxiangCaidanActivity.this, JiaoJieActivity.class, null, 0);
				break;
			}
		}
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				manager.getAbnormal().timeout(KuanxiangCaidanActivity.this, "数据加载失败", new OnClickListener() {

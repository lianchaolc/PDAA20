...
//	private ImageView back; // 退出
	...
	private TextView Ztotalwangdian, Ztotalkuanxiang, Wtotalwangdian, Wtotalkuanxiang;
	...
	private class WanruAdapter extends BaseAdapter {
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			if (arg1 == null) {
				...
				arg1 = LayoutInflater.from(KuanxiangChuruActivity.this).inflate(R.layout.listview_chuangxiangchuru,
						null);
			...
			entity.textView1.setText(wanrulist.get(arg0).getChaochexianlu());
			entity.textView2.setText(wanrulist.get(arg0).getKuanxiangcount() + "");
			...
			public void run() {
				...
				try {// 获取款箱明细接口
					if (zaochu != null && wanru == null) {
						GApplication.mingxi_list = ks.getBoxSendOutEarlyDetail(zaochu.getXianlubianhao(),
						...
						GApplication.mingxi_list = ks.getBoxStorageLateDetail(wanru.getXianlubianhao());
						if (GApplication.mingxi_list != null) {
							handler.sendEmptyMessage(6);
						} else {
							handler.sendEmptyMessage(8);
    ...
    private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				/*
				 * manager.getAbnormal().timeout(KuanxiangChuruActivity.this, "晚收入库未获取到任务,重试?",
			...
			case 2:
				...
				manager.getRuning().remove();
				manager.getAbnormal().timeout(KuanxiangChuruActivity.this, "数据获取超时,重试?", new OnClickListener() {
			...
			case 3:
				...
				manager.getRuning().remove();
				manager.getAbnormal().timeout(KuanxiangChuruActivity.this, "加载异常,重试?", new OnClickListener() {
			...
			case 5:
				...
				manager.getRuning().remove();
				/*
				 * manager.getAbnormal().timeout(KuanxiangChuruActivity.this, "早送出库未能查到任务,重试?",
				 * new View.OnClickListener() {
				 * 
				 * @Override public void onClick(View arg0) { manager.getAbnormal().remove();
				 * getZaoChuInfo(); return; } });
				 */
				getWanRuInfo();
				updateLitView();
				break;
			case 6:
				...
				if (zaochu != null && wanru == null) {
					...
					Skip.skip(KuanxiangChuruActivity.this, KuanXiangZaochuMingxiActivity.class, bundle, 0);
				} else if (zaochu == null && wanru != null) {
			...
			case 8:
				...
				manager.getRuning().remove();
				manager.getAbnormal().timeout(KuanxiangChuruActivity.this, "未获取到任务明细,重试?", new OnClickListener() {
					@Override
					public void onClick(View arg0) {
						manager.getAbnormal().remove();
						getMingXi();
		...
		new Thread() {
			...
			public void run() {
				...
				try {
					...
					GApplication.wanrulist = kxzc.KuanXiangWanru(GApplication.loginJidouId);
					if (GApplication.wanrulist != null) {

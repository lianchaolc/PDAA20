 ...
 * 
 */
public class HomeMangerToAddCashToPackgersActivity extends FragmentActivity implements OnClickListener {
	protected static final String TAG = "HomeMangerToAddCashToPackgersActivity";
	// 组件
	...
	// /声明变量
	public static HomeMangerToAddCashToPackgersActivity instance = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.acctivity_homemangertoadd_cashtopackgers);
	...
	private void initView() {
		sp_quanbei = (Spinner) findViewById(R.id.sp_qunabeibu);// 设置券别

		sp_cansun = (Spinner) findViewById(R.id.sp_cansun);// 设置残损
		sp_banbie = (Spinner) findViewById(R.id.sp_banbie);// 设置版别
		// 标题
		ql_ruku_back = (ImageView) findViewById(R.id.imageView1);
		ql_ruku_back.setOnClickListener(this);

		GApplication.user.getLoginUserName();
		// 抵质押品
		tvMoneyCoun = (TextView) findViewById(R.id.tv_monecount);
		cashreadcard_btn = (Button) findViewById(R.id.cashreadcard_btn);
		cashreadcard_btn.setOnClickListener(this);
		tvCardid = (TextView) findViewById(R.id.tv_bucard);// 显示卡号
		readcash_qunabeibu = (TextView) findViewById(R.id.cash_qunabeibu);// 券别
		tv_redcashcansun = (TextView) findViewById(R.id.cashcansun);
		cashreadmoney = (TextView) findViewById(R.id.cashreadmoney);
		ql_ruku_update = (Button) findViewById(R.id.ql_ruku_update);
		ql_ruku_update.setOnClickListener(this);
		cashtoredadupdata_btn = (Button) findViewById(R.id.cashtoredadupdata_btn);
		cashtoredadupdata_btn.setOnClickListener(this);
		// 显示版别tv
		cash_banbie = (TextView) findViewById(R.id.cash_banbie);
		cash_banbie.setText("");
...
//						moneysetbanbie.toArray(array3);
	...
	public void onClick(View v) {
		...
		case R.id.cashtoredadupdata_btn:// 读卡
//			Log.e(TAG,"TailZeromeid==!!=="+TailZeromeid+"readmeid===!!="+readmeid);
			...
			if ((!(intentvalue.equals(""))) && (readmeid.equals(TailZeromeid))) {// 非空判断&&readmeid.equals()
				...
				Intent intent = new Intent(HomeMangerToAddCashToPackgersActivity.this, Cash_TailZeroAllctivity.class);
		...
		case R.id.ql_ruku_back:
			HomeMangerToAddCashToPackgersActivity.this.finish();
			break;
		case R.id.ql_ruku_update:
			getClearCollateralTaskListAndCount1();
			break;
		case R.id.cashreadcard_btn:
			readmeid = "";
			...
			if (isFastClick() != true) {
				...
				// 长按后
				if (monetype.equals("") || cansunwanczheng.equals("") || cansunwanczheng.equals("")) {
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				manager.getAbnormal().timeout(HomeMangerToAddCashToPackgersActivity.this, "加载超时,重试?", OnClick1);
				break;
			case 1:
				manager.getRuning().remove();
				manager.getAbnormal().timeout(HomeMangerToAddCashToPackgersActivity.this, "网络连接失败,重试?", OnClick1);
				break;
			case 2:
				manager.getRuning().remove();
			...
			case 3:
				manager.getRuning().remove();
				manager.getAbnormal().timeout(HomeMangerToAddCashToPackgersActivity.this, "没有任务",
						new OnClickListener() {
...
//				selectmeid(monetype, moneyid);
	...
	public void showBigToast(String info, int duration) {
		Toast toast = new Toast(HomeMangerToAddCashToPackgersActivity.this);
		toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM, 0, 50);
		TextView tv = new TextView(HomeMangerToAddCashToPackgersActivity.this);
	...
	private void getversioncode(String monetype1) {
		...
		mspinnbanbie = new SpinnerAdapter(HomeMangerToAddCashToPackgersActivity.this,
				android.R.layout.simple_spinner_dropdown_item, array3);
		...
		mSpinnerAdapterquanzhong = new SpinnerAdapter(HomeMangerToAddCashToPackgersActivity.this,
	...
	public void spinnerselect() {
		...
		if (0 != (array2.length)) {
			...
			mSpinnerAdapter = new SpinnerAdapter(HomeMangerToAddCashToPackgersActivity.this,

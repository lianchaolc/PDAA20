...
public class SystemLoginService {
	...
	// 系统登陆业务
	public static SystemUser system_login(String name, String pwd) throws Exception {
		Log.i("name", name);
		Log.i("pwd", pwd);
		// 封装参数
		WebParameter[] Paras = { new WebParameter<String>("arg0", name), new WebParameter<String>("arg1", pwd) };
		// 调用方法

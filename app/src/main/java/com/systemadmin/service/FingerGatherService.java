...
public class FingerGatherService {
	...
	public boolean fingerprintInput(String userId, String finger, byte[] cValue, byte[] cValue1) throws Exception {
		...
		WebParameter[] param = { new WebParameter<String>("arg0", userId), new WebParameter<String>("arg1", finger),
				new WebParameter<byte[]>("arg2", cValue), new WebParameter<byte[]>("arg3", cValue1), };

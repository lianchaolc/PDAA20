...
public class Test {
	...
	public static void httptest() throws Exception {
		...
		/*
		 * nvps.add(new BasicNameValuePair("mobileCode", "13800138000")); nvps.add(new
		 * BasicNameValuePair("userID", "")); httpPost.setEntity(new
		 * UrlEncodedFormEntity(nvps)); CloseableHttpResponse httppHttpResponse2 =
		 * httpClient.execute(httpPost); String str =

...
public class EmptyMoneyBoxOutDoService {
     ...
     * 操作方式=3 钞箱状态=00 （业务单号为空字符串） ATM加钞出库时 操作方式=5 钞箱状态=02 （业务单号为空字符串） 钞箱装钞入库时 操作方式=4
     ...
     * 操作方式=9 钞箱状态=11 （加钞计划编号为空字符串） 新增钞箱入库 操作方式=1 钞箱状态=09 （加钞计划编号和业务单号为空字符串）
     *
     * @param cbinfo
     * @return 成功或者失败
     * @throws Exception
    ...
    public static String cashBoxOutOrIn(String cbinfo) throws Exception {
        ...
        System.out.print("未清回收钞箱==="+cbinfo);

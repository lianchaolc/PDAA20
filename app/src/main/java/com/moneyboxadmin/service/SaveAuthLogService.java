...
public class SaveAuthLogService {
	...
	/**
	 * 
	 * @param planNum    加钞计划编号或者业务单号
	 * @param cashBoxNum 交接的钞箱编号(多个钞箱用|分隔)
	 * @param corpId     机构ID
	 * @param roleId     角色ID
	 * @param cValue     特征值
	 * @param authType   交接类型（见交接说明）
	 * @param perNum     第几个人交接 （一般2个人交接，如果第一人按指纹就传"1";如果第二人按指纹就传"2"）
	 * @param sumPerNum  一共需要几个人交接 如果1个人交接传"1" 如果2个人交接传"2"
	 * @return
	 * @throws Exception
	 */
	public User saveAuthLog(String planNum, String cashBoxNum, String corpId, String roleId, byte[] cValue,
			String authType, String perNum, String sumPerNum) throws Exception {

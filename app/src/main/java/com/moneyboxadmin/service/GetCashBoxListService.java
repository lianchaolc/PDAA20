...
public class GetCashBoxListService {
	 ...
	 * @throws Exception
	 */
	public List<Box> getCashBoxListResult(String corpId, String type) throws Exception {

		String methodName = "getCashBoxList";

		WebParameter[] parameter = { new WebParameter<String>("arg0", corpId), new WebParameter<String>("arg1", type) };

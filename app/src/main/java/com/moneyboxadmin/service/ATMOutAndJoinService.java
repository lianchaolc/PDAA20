...
public class ATMOutAndJoinService {
	 ...
	 * @throws Exception
	 */
	public User saveAtmAddMoneyOut(String cbInfo, String corpId, String roleId, byte[] cValue, String jiachao1,
			String jiachao2) throws Exception {
		...
		WebParameter[] parameter = { new WebParameter<String>("arg0", cbInfo), new WebParameter<String>("arg1", corpId),
				...
				new WebParameter<String>("arg4", jiachao1), new WebParameter<String>("arg5", jiachao2) };

...
import com.fragment.pda.PlanWay_NotClearOut_fragment;
...
public class PlanWay extends Activity implements OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		} /* begin modify by wangmeng 2017-08-11 */
		else if ("未清回收钞箱出库".equals(businessNmae)) {
			if (way == null) { // 计划编号、路线,带有复选框
				way = new PlanWay_NotClearOut_fragment();
			}
			managerClass.getGolbalView().replaceFragment(this, R.id.fragment_lay, way, bundle_business);
		}
		/* end modify by wangmeng 2017-08-11 */
		else {
			if (way == null) { // 计划编号、路线

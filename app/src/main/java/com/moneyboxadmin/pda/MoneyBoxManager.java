...
public class MoneyBoxManager extends Activity implements OnTouchListener {
	...
	public GetBoxNumberBiz getBoxNumber() {
		return boxNumber = boxNumber == null ? new GetBoxNumberBiz() : boxNumber;
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		clcikReplace = new OnClickListener() {
			...
			public void onClick(View arg0) {
				// 获取未处理的业务数量
				magagerClass.getRuning().runding(MoneyBoxManager.this, "正在获取未处理业务数量...");
		...
		getBoxNumber().hand_boxNum = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				case -4:
					// 连接超时提示
					magagerClass.getAbnormal().timeout(MoneyBoxManager.this, "连接超时！要重试吗？", clcikReplace);
					break;
				case -1:
					// 连接超时提示
					magagerClass.getAbnormal().timeout(MoneyBoxManager.this, "连接异常！要重试吗？", clcikReplace);
					break;
		...
		if (MotionEvent.ACTION_UP == even.getAction()) {
			...
			case R.id.emptyboxout:
				...
				if (empty.getText().equals("0")) {
					...
					magagerClass.getGolbalutil().gotoActivity(MoneyBoxManager.this, PlanWay.class, bundle,
							magagerClass.getGolbalutil().ismover);
				}
			...
			case R.id.notclearout:
				...
				if (notclear.getText().equals("0")) {
					 ...
					 * BoxAddStop.class, bundle, magagerClass.getGolbalutil().ismover);
					 */
					magagerClass.getGolbalutil().gotoActivity(MoneyBoxManager.this, PlanWay.class, bundle,
							magagerClass.getGolbalutil().ismover);
				}
			...
			case R.id.stopout:
				...
				magagerClass.getGolbalutil().gotoActivity(MoneyBoxManager.this, BoxAddStop.class, bundle,
						magagerClass.getGolbalutil().ismover);
				break;
			// 钞箱装钞入库
			case R.id.moneyboxin:
			...
			case R.id.back:
				...
				final SureCancelButton cancelButton = new SureCancelButton();
				cancelButton.makeSuerCancel(MoneyBoxManager.this, "您确认要退出钞箱业务操作？", new OnClickListener() {
					@Override
					public void onClick(View arg0) {

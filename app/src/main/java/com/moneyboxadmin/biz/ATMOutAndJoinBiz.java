...
public class ATMOutAndJoinBiz {
	...
	/**
	 * 
	 * @param cbInfo cbInfo:加钞计划编号;业务单号;操作方式;钞箱品牌信息;钞箱编号;钞箱状态;审核员ID;复核员ID;机构ID（多列时用
	 *               |分隔）
	 * @param corpId 机构ID
	 * @param roleId 角色ID
	 * @param cValue 特征值
	 ...
	 * @return
	 */
	public String getCbInfo(String plan, List<BoxDetail> list, String userid1, String userid2, String corpid) {

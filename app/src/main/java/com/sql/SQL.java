...
public class SQL {
	...
	public static void createTable() {
		// getDB().execSQL("create table if not exists load(id INTEGER PRIMARY KEY
		// AUTOINCREMENT, len VARCHAR(20))");

		try {
			getDB().execSQL(
					"create table if not exists load2(id INTEGER PRIMARY KEY AUTOINCREMENT, len1 VARCHAR(20),len2 VARCHAR(20))");
		} catch (Exception e) {
			e.getMessage();
		}
	...
	/**
	 * 插入 "insert into download values (null,'102456','4552342')"
	 */

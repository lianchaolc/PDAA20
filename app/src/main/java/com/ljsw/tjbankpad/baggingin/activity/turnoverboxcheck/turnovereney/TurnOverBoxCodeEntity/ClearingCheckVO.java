 ...
 * 清分管理复核的实体类
 */
public class ClearingCheckVO implements Serializable {
	...
	public void setTcktNum(String tcktNum) {
		this.tcktNum = tcktNum;
	}
...
private String  tcktName;
	...
	public boolean equals(Object obj) {
		if(obj == null){
			...
			if(obj instanceof ClearingCheckVO){
				ClearingCheckVO vo = (ClearingCheckVO) obj;

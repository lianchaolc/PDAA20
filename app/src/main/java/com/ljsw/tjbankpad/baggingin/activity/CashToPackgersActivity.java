...
/***
 * 现金装袋 清分人员操作 20190426 lc 201910.10
 * 
 * @author Administrator】
 * 
 */
public class CashToPackgersActivity extends FragmentActivity implements OnClickListener {
	...
	// /声明变量
	public static CashToPackgersActivity instance = null;
...
//	private powercontrol rFidPowerControl;// yang
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.acctivity_cashtopackgers);
...
//			Log.e(TAG,"TailZeromeid==!!=="+TailZeromeid+"readmeid===!!="+readmeid);
			...
			if ((!(intentvalue.equals(""))) && (readmeid.equals(TailZeromeid))) {// 非空判断&&readmeid.equals()
				...
				Intent intent = new Intent(CashToPackgersActivity.this, Cash_TailZeroAllctivity.class);
		...
		case R.id.ql_ruku_back:
			CashToPackgersActivity.this.finish();
			break;
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				manager.getAbnormal().timeout(CashToPackgersActivity.this, "加载超时,重试?", OnClick1);
				break;
			case 1:
				manager.getRuning().remove();
				manager.getAbnormal().timeout(CashToPackgersActivity.this, "网络连接失败,重试?", OnClick1);
				break;
			case 2:
				manager.getRuning().remove();
			...
			case 3:
				manager.getRuning().remove();
				manager.getAbnormal().timeout(CashToPackgersActivity.this, "没有任务", new OnClickListener() {
...
//		// ===================================
	...
	public void showBigToast(String info, int duration) {
		Toast toast = new Toast(CashToPackgersActivity.this);
		toast.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM, 0, 50);
		TextView tv = new TextView(CashToPackgersActivity.this);
	...
	private void getversioncode(String monetype1) {
		...
		mspinnbanbie = new SpinnerAdapter(CashToPackgersActivity.this, android.R.layout.simple_spinner_dropdown_item,
				array3);
		...
		mSpinnerAdapterquanzhong = new SpinnerAdapter(CashToPackgersActivity.this,
	...
	public void spinnerselect() {
		...
		if (0 != (array2.length)) {
			...
			mSpinnerAdapter = new SpinnerAdapter(CashToPackgersActivity.this,

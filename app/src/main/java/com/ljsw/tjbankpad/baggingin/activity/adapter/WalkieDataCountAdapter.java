 ...
 */
//  里面只有一个textview
public class WalkieDataCountAdapter extends BaseAdapter {
	private List<String> walkList;
	private Context mContext;
	private LayoutInflater inflater;

	public WalkieDataCountAdapter(List<String> walkList, Context mContext) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (mVHAWailk == null) {
			...
			convertView = inflater.inflate(R.layout.listview_dizhiyapinrenwu_item, null, false);
			TextView intercomid = (TextView) convertView.findViewById(R.id.rewnuintercomid);

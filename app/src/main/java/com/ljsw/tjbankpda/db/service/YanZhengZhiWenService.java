...
public class YanZhengZhiWenService {
	public SystemUser checkFingerprint(String corpId, String roleId, byte[] cValue) throws Exception {
		...
		System.out.println("----------checkFingerprint传参:" + corpId + ":" + roleId + ":" + cValue);
		SoapObject soap = null;
		soap = WebServiceFromThree.getSoapObject(mothedName, param, FixationValue.NAMESPACE, FixationValue.URL);
	 ...
	 * @throws Exception
	 */
	public SystemUser checkFingerprint2(String corpId, String roleId, byte[] cValue) throws Exception {
		SystemUser user = null;
		String mothedName = "checkFingerprint";
		WebParameter[] param = { new WebParameter<String>("arg0", corpId), new WebParameter<String>("arg1", roleId),
				new WebParameter<byte[]>("arg2", cValue) };

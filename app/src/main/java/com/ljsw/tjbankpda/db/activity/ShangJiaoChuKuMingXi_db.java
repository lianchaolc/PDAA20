...
public class ShangJiaoChuKuMingXi_db extends FragmentActivity implements OnClickListener {
	...
	class ShangJiaoChuKuAdapter extends BaseAdapter {
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			if (arg1 == null) {
				...
				view = new ViewHodler();
				view.renwu = (TextView) arg1.findViewById(R.id.adapter_jihuadan_zhongkong_type);
				view.count = (TextView) arg1.findViewById(R.id.adapter_jihuadan_zhongkong_count);
				arg1.setTag(view);
			} else {
				view = (ViewHodler) arg1.getTag();
			}
			view.renwu.setText(o_Application.chukumingxi.getZhixianlu().get(arg0));
			view.count.setText(o_Application.chukumingxi.getZzxshuliang().get(arg0));
			return arg1;
		}

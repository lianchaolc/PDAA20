...
public class o_Application {
    ...
    public static List<String> numberlist1 = new ArrayList<String>();// 一,二维码用
    public static String wrong = null;// 错误的扫箱
    public static String quanbie = "";// 声明
    // 扫描过滤用
    ...
    // 抵制押品的入库
    public static List<DiZhiYaPinRuKu> dizhiyapinruku = new ArrayList<DiZhiYaPinRuKu>();

    // 请领入库(单个选中对象)抵制押品的
    public static DiZhiYaPinChaiXiang qlruku1;
    // 请领入库(单个选中对象)
    public static QingLingRuKu qlruku;

    /// 抵制押品出库

//	public static LocationManagerCode LocationManager;

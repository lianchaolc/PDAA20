	...
	public boolean onTouch(View view, MotionEvent even) {
		...
		if (MotionEvent.ACTION_UP == even.getAction()) {
			...
			case R.id.system_login_cancel:
				...
				QingFenYuanDengLu.this.setResult(QingFenYuanDengLu.this.RESULT_OK, intent);
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				managerClass.getAbnormal().timeout(QingFenYuanDengLu.this, "登录超时,重试?", onclickreplace);
				break;
			case 1:
				managerClass.getRuning().remove();
				managerClass.getAbnormal().timeout(QingFenYuanDengLu.this, "网络连接失败,重试?", onclickreplace);
				break;
			...
			case 2:
				...
				if (!o_Application.qingfenyuan.getOrganizationId().equals(o_Application.kuguan_db.getOrganizationId())
					...
					managerClass.getAbnormal().timeout(QingFenYuanDengLu.this, "请使用清分管理员身份!", new OnClickListener() {
					...
					if (o_Application.left_user != null) {
						if (o_Application.qingfenyuan.getLoginUserName()
							...
							managerClass.getAbnormal().timeout(QingFenYuanDengLu.this, "重复验证!", new OnClickListener() {
								@Override
								public void onClick(View arg0) {
									managerClass.getAbnormal().remove();
								}
			...
			case 3:
				managerClass.getRuning().remove();
				managerClass.getAbnormal().timeout(QingFenYuanDengLu.this, S_application.wrong, new OnClickListener() {
					@Override
					public void onClick(View arg0) {
						editname.setText("");
						editpwd.setText("");

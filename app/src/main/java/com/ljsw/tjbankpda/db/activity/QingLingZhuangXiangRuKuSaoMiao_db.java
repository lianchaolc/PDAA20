...
public class QingLingZhuangXiangRuKuSaoMiao_db extends FragmentActivity implements OnClickListener {
	 ...
	 */
	public void Xianlu() {
		manager.getRuning().runding(QingLingZhuangXiangRuKuSaoMiao_db.this, "获取线路中.....");
		new Thread() {
			public void run() {
				super.run();
				try {
					params = is.getJigouLeibie(GApplication.user.getOrganizationId());
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				Skip.skip(QingLingZhuangXiangRuKuSaoMiao_db.this, RenWuLieBiao_db.class, null, 0);
				break;
			case 2:
				manager.getRuning().remove();
				manager.getAbnormal().timeout(QingLingZhuangXiangRuKuSaoMiao_db.this, "提交超时,重试?",
						new OnClickListener() {
			...
			case 3:
				manager.getRuning().remove();
				manager.getAbnormal().timeout(QingLingZhuangXiangRuKuSaoMiao_db.this, jiaojieOk + "重试？",
						new OnClickListener() {
			...
			case 4:
				manager.getRuning().remove();
				manager.getAbnormal().timeout(QingLingZhuangXiangRuKuSaoMiao_db.this, "网络连接失败,重试?",
						new OnClickListener() {
			...
			case 6:
				manager.getRuning().remove();
				manager.getAbnormal().timeout(QingLingZhuangXiangRuKuSaoMiao_db.this, "连接超时，重新链接？", onclickreplace);
				break;
			case 7:
				manager.getRuning().remove();
				manager.getAbnormal().timeout(QingLingZhuangXiangRuKuSaoMiao_db.this, "获取失败", onclickreplace);
				break;
			case 8:
				manager.getRuning().remove();
				manager.getAbnormal().timeout(QingLingZhuangXiangRuKuSaoMiao_db.this, "信息加载异常", onclickreplace);
				break;
			case 15:
				manager.getRuning().remove();
				manager.getAbnormal().timeout(QingLingZhuangXiangRuKuSaoMiao_db.this, "连接超时，重新链接？", onClick);
				break;
			case 13:
				manager.getRuning().remove();
				manager.getAbnormal().timeout(QingLingZhuangXiangRuKuSaoMiao_db.this, "获取失败", onClick);
				break;
			case 14:
				manager.getRuning().remove();
				manager.getAbnormal().timeout(QingLingZhuangXiangRuKuSaoMiao_db.this, "信息加载异常", onClick);
				break;
			}
		...
		new Thread() {
			...
			public void run() {
				...
				try {
					 ...
					 */
					jiaojieOk = jiaojie.saveAuthLog(cashBoxNum, userId, "", "22", o_Application.qlruku.getDanhao());
...
//					}
	...
	class LeftAdapter extends BaseAdapter {
		LeftHolder lh;
		LayoutInflater lf = LayoutInflater.from(QingLingZhuangXiangRuKuSaoMiao_db.this);

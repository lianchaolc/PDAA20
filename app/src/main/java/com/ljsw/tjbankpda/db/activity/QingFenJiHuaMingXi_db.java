...
public class QingFenJiHuaMingXi_db extends FragmentActivity implements OnClickListener {
	...
	/*
	 * public void getData() { for (int i = 0; i < 10; i++) { list.add(new
	 * JiHuaDan_Zhongkong("西青" + i + "线", "3" + i)); } }
	 */

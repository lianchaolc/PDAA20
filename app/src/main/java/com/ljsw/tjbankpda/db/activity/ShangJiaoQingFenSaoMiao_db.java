...
public class ShangJiaoQingFenSaoMiao_db extends FragmentActivity implements OnClickListener {
	...
	class LeftAdapter extends BaseAdapter {
		LeftHolder lh;
		LayoutInflater lf = LayoutInflater.from(ShangJiaoQingFenSaoMiao_db.this);
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			lh.tv.setText(o_Application.qingfendanmingxi.getZhouzhuanxiang().get(arg0));
			return arg1;
		}

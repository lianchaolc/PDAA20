...
public class ShangJiaoQingFenSaoMiao implements INotify {
	...
	public void getNumber(String number) {
		...
		int aa = -1;
		for (int i = 0; i < o_Application.qingfendanmingxi.getZhouzhuanxiang().size(); i++) {
			if (o_Application.qingfendanmingxi.getZhouzhuanxiang().get(i).equals(str)) {
				aa = i;
				break;
			}
		}
		...
		System.out.println("=============扫描完成，集合长度：" + o_Application.numberlist.size());
	}

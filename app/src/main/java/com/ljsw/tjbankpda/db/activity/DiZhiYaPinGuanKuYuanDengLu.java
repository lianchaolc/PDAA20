...
/***
 * 抵质押品管库员上缴清分三次指纹错误后需要账号密码
 */

@SuppressLint("HandlerLeak")
public class DiZhiYaPinGuanKuYuanDengLu extends Activity implements OnTouchListener {
    // 系统登陆界面
    Button login; // 登陆按钮
    Button cancel; // 取消按钮
        ...
        if (MotionEvent.ACTION_UP == even.getAction()) {
            switch (view.getId()) {
                ...
                case R.id.system_login_cancel:
                    ...
                    DiZhiYaPinGuanKuYuanDengLu.this.setResult(DiZhiYaPinGuanKuYuanDengLu.this.RESULT_OK, intent);
                    DiZhiYaPinGuanKuYuanDengLu.this.finish();
                    break;
    ...
    public void login() {
        managerClass.getRuning().runding(DiZhiYaPinGuanKuYuanDengLu.this, "登录中...");
        new Thread() {
            @Override
            public void run() {
                super.run();
                try {
                    ...
                    if (o_Application.diziyuan != null) {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    ...
                    managerClass.getAbnormal().timeout(DiZhiYaPinGuanKuYuanDengLu.this, "登录超时,重试?", onclickreplace);
                    break;
                case 1:
                    managerClass.getRuning().remove();
                    managerClass.getAbnormal().timeout(DiZhiYaPinGuanKuYuanDengLu.this, "网络连接失败,重试?", onclickreplace);
                    break;

                case 2:
                    managerClass.getRuning().remove();
                    if (!o_Application.diziyuan.getOrganizationId().equals(o_Application.kuguan_db.getOrganizationId())
                            || !o_Application.diziyuan.getLoginUserId().equals("29")) {
                        managerClass.getAbnormal().timeout(DiZhiYaPinGuanKuYuanDengLu.this, "请使用抵质押品管库员身份!", new OnClickListener() {
                        ...
                        if (o_Application.left_user != null) {
                            if (o_Application.diziyuan.getLoginUserName()
                                ...
                                managerClass.getAbnormal().timeout(DiZhiYaPinGuanKuYuanDengLu.this, "重复验证!", new OnClickListener() {
                                    @Override
                                    public void onClick(View arg0) {
                                        managerClass.getAbnormal().remove();
                                    }
                                ...
                                DiZhiYaPinGuanKuYuanDengLu.this.setResult(100, intent);
                ...
                case 3:
                    managerClass.getRuning().remove();
                    managerClass.getAbnormal().timeout(DiZhiYaPinGuanKuYuanDengLu.this, S_application.wrong, new OnClickListener() {
                        @Override
                        public void onClick(View arg0) {
                            editname.setText("");
                            editpwd.setText("");

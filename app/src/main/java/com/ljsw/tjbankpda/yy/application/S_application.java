...
//	public static String yayunOrizatuion;
	...
	public static String s_huoweiguanliyaunid; // 货位管理员id lc
	public static String s_huoweiguanlijigouid; // 货位管理机构id
	public static String s_huoweiguanliyuan;// 货位管理员 lc
	public static String s_zhanghuzhonginguanliyaun; // 账户中心管理员lc
	public static String s_zhanghuzhonginguanliId; // 机构id lc

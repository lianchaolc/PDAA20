...
public class YaYunRwMingxiActivity extends FragmentActivity implements OnClickListener {
	...
	private YayunyuanSelectRenWuUserBaseEntity YaYunLb1; // 被选中的网点 修改后
...
//			YaYunLb yb = (YaYunLb) bundle.getSerializable("YaYunLb");
			YayunyuanSelectRenWuUserBaseEntity YaYunLb1 = (YayunyuanSelectRenWuUserBaseEntity) bundle
					.getSerializable("YaYunLb");

...
public class IKuGuanYuanService {
	...
	public String SaveAuthLogYayun(String zzxShangjiao, String zzxQingling, String userWangdian, String userYayun,
			String qlJiaojieType, String sjJiaojieType, String qlpaigongdan) throws Exception {
		...
		WebParameter[] param = { new WebParameter<String>("arg0", zzxShangjiao),
				...
				new WebParameter<String>("arg3", userYayun), new WebParameter<String>("arg4", qlJiaojieType),
				new WebParameter<String>("arg5", sjJiaojieType), new WebParameter<String>("arg6", qlpaigongdan) };// 传入参数
		SoapObject soap = null;// 创建返回值接收对象
		soap = WebServiceFromThree.getSoapObject(methodName, param, FixationValue.NAMESPACE, FixationValue.URL5);// 根据路径获得返回值

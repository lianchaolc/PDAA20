 ...
 */
public class SjzzxSaomiaoActivity extends FragmentActivity implements OnClickListener {
	...
	class SjwsmiaoAdapter extends BaseAdapter {
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			if (arg1 == null) {
				...
				arg1 = LayoutInflater.from(SjzzxSaomiaoActivity.this).inflate(R.layout.item_qlsm_s, null);
	...
	public void onClick(View arg0) {
		...
		case R.id.btn_sjsmQd:// 跳转到押运任务交接页面
			managerClass.getRuning().runding(SjzzxSaomiaoActivity.this, "正在开启指纹验证,请等待...");
			Skip.skip(SjzzxSaomiaoActivity.this, YyrwJiaojieActivity.class, null, 0);
			break;

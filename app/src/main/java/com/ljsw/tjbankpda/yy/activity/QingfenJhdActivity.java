...
//	int aa;
	...
	class LiebiaoAdapter extends BaseAdapter {
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			if (arg1 == null) {
				...
				arg1 = LayoutInflater.from(QingfenJhdActivity.this).inflate(R.layout.item_qingfen_jhd_s, null);
	 ...
	 * event.getRepeatCount() == 0) { return true; } if (keyCode ==
	 * KeyEvent.KEYCODE_SEARCH) { return true; } return super.onKeyDown(keyCode,
	 * event); }
	 */

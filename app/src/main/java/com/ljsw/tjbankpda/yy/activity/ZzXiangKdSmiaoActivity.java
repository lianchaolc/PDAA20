...
//				dialog.show();
				...
				managerClass.getGoBack().back(ZzXiangKdSmiaoActivity.this, "验证成功", new OnClickListener() {
					@Override
					public void onClick(View arg0) {
	...
	class LiebiaoAdapter extends BaseAdapter {
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			if (arg1 == null) {
				...
				arg1 = LayoutInflater.from(ZzXiangKdSmiaoActivity.this).inflate(R.layout.item_qingfen_zzxhdsm_s, null);

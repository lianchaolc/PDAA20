 ...
 */
public class QingfenJhdMxActivity extends FragmentActivity implements OnClickListener, OnItemClickListener {
			...
			public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
				if (isFlag == 1) {
					...
					if (arg1) {
						...
						findViewById(R.id.btn_qfsh).setBackgroundResource(R.drawable.buttom_selector_bg);
						...
						total = 0;
						findViewById(R.id.btn_qfsh).setBackgroundResource(R.drawable.gray_btn_bg);
	...
	class WanChengAdapter extends BaseAdapter {
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			if (arg1 == null) {
				...
				arg1 = LayoutInflater.from(QingfenJhdMxActivity.this).inflate(R.layout.item_qingfen_wanceng_s, null);
				entity.checkbox1 = (CheckBox) arg1.findViewById(R.id.wccheckBox);
				entity.textView1 = (TextView) arg1.findViewById(R.id.qfxiaozuName);
				entity.textView2 = (TextView) arg1.findViewById(R.id.qfxianluName);
				arg1.setTag(entity);
			} else {
					...
					if (flag == true) {
						...
						if (newlist.size() != 0) {
							for (int i = 0; i < newlist.size(); i++) {
								if (list.get(position).getQfXiaozu().equals(newlist.get(i).getQfXiaozu())) {
									aaaaa = i;
									break;
								} else {
									aaaaa = -1;
	...
	class WeiWanChengAdapter extends BaseAdapter {
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			if (arg1 == null) {
				entity = new QingfenEntivity();
				arg1 = LayoutInflater.from(QingfenJhdMxActivity.this).inflate(R.layout.item_qingfen_weiwanceng_s, null);
				entity.textView1 = (TextView) arg1.findViewById(R.id.qfxianluName1);
				entity.textView2 = (TextView) arg1.findViewById(R.id.qfxiaozuName1);
				arg1.setTag(entity);
			} else {
				entity = (QingfenEntivity) arg1.getTag();
			}
	...
	public void onClick(View arg0) {
		...
		case R.id.btn_qfsh:// 跳转 传选择的集合过去
			managerClass.getRuning().runding(QingfenJhdMxActivity.this, "开启扫描功能中...");
			Bundle bundle = new Bundle();
			bundle.putSerializable("newlist", (Serializable) newlist);
			Skip.skip(QingfenJhdMxActivity.this, ZzXiangKdSmiaoActivity.class, bundle, 0);
			break;
		}
	}
